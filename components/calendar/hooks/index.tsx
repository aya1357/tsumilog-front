...
export const useCalendarEvents = () => {
  const events = useMemo<Schedule[]>(
    () => [
      {
        id: 'id-1',
        text: '予定A',
        color: COLORS[0],
        fromAt: new Date(2025, 3, 1),
        toAt: new Date(2025, 3, 1)
      },
      {
        id: 'id-2',
        text: '予定B',
        color: COLORS[1],
        fromAt: new Date(2025, 3, 3),
        toAt: new Date(2025, 3, 5)
      },
      {
        id: 'id-3',
        text: '予定C',
        color: COLORS[2],
        fromAt: new Date(2025, 3, 4),
        toAt: new Date(2025, 3, 8)
      },
      {
        id: 'id-4',
        text: '予定D',
        color: COLORS[3],
        fromAt: new Date(2025, 3, 21),
        toAt: new Date(2025, 3, 24)
      },
      {
        id: 'id-5',
        text: '予定E',
        color: COLORS[4],
        fromAt: new Date(2025, 3, 23),
        toAt: new Date(2025, 3, 23)
      },
      {
        id: 'id-6',
        text: '予定F',
      ...
      },
      {
        ...
        text: '予定H',
        color: COLORS[7],
        fromAt: new Date(2025, 3, 29),
        toAt: new Date(2025, 3, 29)
      },
      {
        id: 'id-9',
        text: '予定I',
        color: COLORS[8],
        fromAt: new Date(2025, 3, 30),
        toAt: new Date(2025, 3, 31)
      },
      {
        id: 'id-10',
        text: '予定J',
        color: COLORS[9],
        fromAt: new Date(2025, 3, 31),
        toAt: new Date(2025, 3, 31)
      }
    ],
    []
